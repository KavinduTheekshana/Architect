            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('app/image/logo-mob-icon.png')}}" style="width: 50px;" alt="">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="text-decoration-none" href="{{ route('members') }}" :active="request()->routeIs('members')">
                        {{ __('Members') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="text-decoration-none" href="{{ route('projects-list') }}" :active="request()->routeIs('projects-list')">
                        {{ __('Projects') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="text-decoration-none" href="{{ route('awards-list') }}" :active="request()->routeIs('awards-list')">
                        {{ __('Awards') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="text-decoration-none" href="{{ route('kpXZbznHlU') }}" :active="request()->routeIs('kpXZbznHlU')">
                        {{ __('Users') }}
                    </x-jet-nav-link>
                </div>
                @endif
